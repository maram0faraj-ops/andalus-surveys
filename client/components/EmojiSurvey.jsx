...
const questions = [
  { id: 'organizationRating', text: 'كيف تقييم مستوى التنظيم العام للمعرض العلمي من حيث ترتيب الأركان وسهولة التنقّل بينها؟' },
  { id: 'innovationRating', text: 'إلى أي مدى كانت أفكار المشاريع المعروضة مبتكرة ومعبّرة عن مهارات الطالبات وقدراتهنّ العلمية؟' },
  { id: 'understandingRating', text: 'هل ساهم المعرض في تعزيز فهمكم للتجارب العلمية المعروضة من حيث وضوح الشرح وتفاعل الطالبات؟' },
  { id: 'environmentRating', text: 'ما مدى رضاكم عن البيئة العامة للمعرض، وتوفّر المعلومات؟' }
];
    ...
    return (
      <div className="survey-wrapper">
        <div className="survey-container success-container">
          ...
          <p>تم تسجيل تقييمكِ للمعرض العلمي التكاملي  بنجاح.</p>
        </div>
      </div>
    );
  }
